<?php
  ...
  function getData($conn, $sender, $receiver){
    ...
    $sql = "SELECT * FROM message WHERE (sender = '$sender' OR receiver = '$sender') AND (sender = '$receiver' OR receiver = '$receiver') ORDER BY sendtime";
  ...
  function getDetail($conn, $role_id, $receiver){
    ...
    $sql2 = "SELECT context,sendtime FROM message WHERE (sender = '$role_id' OR receiver = '$role_id') AND (sender = '$receiver' OR receiver = '$receiver') ORDER BY sendtime DESC LIMIT 1";
