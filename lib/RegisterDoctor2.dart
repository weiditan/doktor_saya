...
class RegisterDoctor2 extends StatefulWidget {
  @override
  _RegisterDoctor2State createState() => _RegisterDoctor2State();
}

class _RegisterDoctor2State extends State<RegisterDoctor2> {
